...
- [关于开源协议：](#关于开源协议)
- [关于Linux发行版本类型：](#关于linux发行版本类型)


### 关于开源协议：
+ 👉: **[GNU GPL(GNU General Public License，GNU通用公共许可证)](https://www.gnu.org/licenses/gpl.html)**，协议规则：    
...
+ 👉:**Apache Liscense Version(Apache 许可证版本)**，协议规则：  
